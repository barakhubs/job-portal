                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Job Title Here">
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12">
                        <div class="form-group select-group">
                            ...
                            foreach($rows as $row)
                            { ?>
                                <option style="text-transform: capitalize;" value="<?= $row['id']; ?>"><?= $row['title']; ?></option>
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12">
                        <div class="form-group select-group">
                            ...
                            <select class="form-select form-control" name="experience">
                                ...
                                <option value="2">More Than 2 Yrs</option>
                                <option value="3">More Than 3 Yrs</option>
                                <option value="4">More Than 5 Yrs</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-12 col-md-12">
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="date" name="deadline" class="form-control" placeholder="Application Deadline Date">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-12 col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            <label>Salary</label>
                            <input type="text" class="form-control" placeholder="200,000 rial" name="salary">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            <label>Location</label>
                            <input type="text" class="form-control" placeholder="Zabid" name="location">
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <button name="submit" type="submit" class="default-btn">Post A Job </button>
                    </div>
                </div>
            </form>
        </div>
